...
class ElectrumGui:
    ...
    def __init__(self, config, network):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'freilectrum create'"
            exit()
    ...
    def network_dialog(self):
        print("use 'freilectrum setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'freilectrum setconfig' to change your settings")
        return True
