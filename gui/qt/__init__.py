...
class ElectrumGui:
    ...
    def build_tray_menu(self):
        ...
        m.addSeparator()
        m.addAction(_("Exit FreiLectrum"), self.close)
    ...
    def init_lite(self):
        ...
        if not self.check_qt_version():
            if self.config.get('lite_mode') is True:
                msg = "FreiLectrum was unable to load the 'Lite GUI' because it needs Qt version >= 4.7.\nChanging your config to use the 'Classic' GUI"
    ...
    def main(self, url):
        ...
        if 1:
            ...
            self.tray.setToolTip('FreiLectrum')
